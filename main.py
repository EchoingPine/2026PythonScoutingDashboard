...
st.session_state.comp = st.sidebar.selectbox("**:material/event: Competition**", [config.EVENTS[key]["Name"] for key in config.EVENTS] + ["All Competitions"], key="competition_select")
nav.run()